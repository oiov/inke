    ...
    <div className={className + " relative inline-block text-left"}>
      ...
      >
        <button
          ...
          className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border border-yellow-400 transition-all duration-75 focus:outline-none active:scale-95 sm:h-9 sm:w-9"
        >
          <Image
            alt={email}
